...
Portfolio_Cleaning_Warehouse: "Portfolio Cleaning/Warehouse",
Or_1:"Or",
...
Portfolio_Cleaning_Warehouse: "Портфолио Оператор Уборки/Складской специалист",
...
Py_Adv: "Python — Продвинутый",
java_elemet: "Java - Элементарно",
Java_calc: "Интерфейсный калькулятор и не интерфейсный",
Py_projects: "Python Проект:",
cSharp_Element: "C# - Элементарно",
Pet_Proj_SliderCrazy: "Пэт-Проект - Slider Crazy (практика)",
Vue_PetProgects: "Пэт-Проект - Todo App (Новая/Старая Версия)",
portfolio_official: "Портфолио",
sliderCrazy_practice: "Slider Crazy (практика)",
Manga_Chan_ComingSoon: "Manga--Chan--Anime--Chan (Скоро)",
TrackerCleaning_comingSoon: "Tracker Cleaning (Скоро)",
TodoApp_NEWOLD_Version: "Todo App (Новая/Старая Версия)",
JuniorSpecialist_Level4: "Младший ИТ-Специалист - Уровень 4",
ITTechician_Level4: "IT-Техник - Уровень 4",
CERT_EST_LANG_A2: "Сертификат по эстонскому языку уровень A2 (официальный) 60%:",
cert_py_basic: "Python (Базовый) Сертификат",
int_to_prog_practice: "Введение в программирование (практика)",
...
Portfolio_Cleaning_Warehouse: "Portfolio Puhastusteenindaja/Laospetsialist",
...
Py_Adv: "Python – edasijõudnutele",
java_elemet: "Java – algtase",
Java_calc: "Kalkulaator (liidesega ja ilma)",
Py_projects: "Pythoni projektid:",
cSharp_Element: "C# – algtase",
Pet_Proj_SliderCrazy: "Isiklik projekt – Slider Crazy (praktika)",
Vue_PetProgects: "Isiklik projekt – Todo-rakendus (uus/vana versioon)",
portfolio_official: "Portfoolio",
sliderCrazy_practice: "Slider Crazy (praktika)",
Manga_Chan_ComingSoon: "Manga-Chan-Anime-Chan (valmimas)",
TrackerCleaning_comingSoon: "Tracker Cleaning (valmimas)",
TodoApp_NEWOLD_Version: "Todo-rakendus (uus/vana versioon)",
JuniorSpecialist_Level4: "IT-süsteemide nooremspetsialist – 4. tase",
ITTechician_Level4: "IT-tehnik – 4. tase",
CERT_EST_LANG_A2: "Eesti keele A2-taseme tunnistus (ametlik) 60%:",
cert_py_basic: "Pythoni (algtase) tunnistus",
int_to_prog_practice: "Sissejuhatus programmeerimisse (praktika)",
